...
Shader "Toon/TGV_CustomStoneSpherical"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 CalculateShadowMask343_g61151(  )
			{
				#if defined(SHADOWS_SHADOWMASK) && defined(LIGHTMAP_ON)
				half4 shadowMask = inputData.shadowMask;
				#elif !defined (LIGHTMAP_ON)
						 ...
						 ) : SV_Target
			{
				...
				float3 WorldPosition288_g61151 = WorldPosition;
				float3 WorldPosition337_g61151 = WorldPosition288_g61151;
				float2 ScreenUV286_g61151 = (ScreenPosNorm).xy;
				float2 ScreenUV337_g61151 = ScreenUV286_g61151;
				float3 tanNormal280_g61151 = BlendedNormals169;
				float3 worldNormal280_g61151 = normalize( float3( dot( tanToWorld0, tanNormal280_g61151 ), dot( tanToWorld1, tanNormal280_g61151 ), dot( tanToWorld2, tanNormal280_g61151 ) ) );
				float3 WorldNormal281_g61151 = worldNormal280_g61151;
				float3 WorldNormal337_g61151 = WorldNormal281_g61151;
				half4 localCalculateShadowMask343_g61151 = CalculateShadowMask343_g61151();
				float4 ShadowMask360_g61151 = localCalculateShadowMask343_g61151;
				float4 ShadowMask337_g61151 = ShadowMask360_g61151;
				float3 localAdditionalLightsLambertMask171x337_g61151 = AdditionalLightsLambertMask171x( WorldPosition337_g61151 , ScreenUV337_g61151 , WorldNormal337_g61151 , ShadowMask337_g61151 );
				float3 temp_output_361_0 = ( ( ase_lightAtten * ase_lightColor.rgb * ase_lightColor.a ) + localAdditionalLightsLambertMask171x337_g61151 );
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;185;-880,-4880;Inherit;False;2436;1091;Comment;32;141;171;140;143;144;145;146;147;149;150;142;154;148;155;158;159;156;162;161;181;163;164;165;166;109;214;157;153;360;361;362;363;Custom Lighting;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;361;-438.5193,-4150.607;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;165;960,-4368;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleAddOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;362;672,-4352;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;363;352,-4352;Inherit;False;SRP Additional Light;-1;;61149;6c86746ad131a0a408ca599df5f40861;3,6,1,351,0,23,0;6;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;345;FLOAT3;0,0,0;False;346;FLOAT3;0,0,0;False;347;FLOAT;0.5;False;32;FLOAT4;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WireNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;364;-272,-4208;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;360;-720,-4144;Inherit;False;SRP Additional Light;-1;;61151;6c86746ad131a0a408ca599df5f40861;3,6,1,351,0,23,0;6;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;345;FLOAT3;0,0,0;False;346;FLOAT3;0,0,0;False;347;FLOAT;0.5;False;32;FLOAT4;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;365;-864,-4528;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LightAttenuation, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;140;-816,-4496;Inherit;False;0;1;FLOAT;0
...
WireConnection;360;2;365;0
WireConnection;365;0;171;0
WireConnection;351;2;170;0
ASEEND*/
//CHKSM=B2F88AADAE307C14FC777640EB3DB3B94AB6D430